...
export const modifyNote = async (userId: string, id: string, note: any) => {
  return await updateNote(userId, id, note);
};

export const removeNote = async (userId: string, id: string) => {
